...
namespace ExportExcel
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void NPOI_export_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void EPPlus_export_Click(object sender, RoutedEventArgs e)
        {
            List<Student> students = GenerateRandomData(100);
        ...
        private void ClosedXML_export_Click(object sender, RoutedEventArgs e)
        {
            List<Student> students = GenerateRandomData(100);
        ...
        private async void OleDB_export_ClickAsync(object sender, RoutedEventArgs e)
        {
            List<Student> students = GenerateRandomData(100);
